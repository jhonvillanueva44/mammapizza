                  ...
                  {filter.tamanio === 'todos' && (
                    <div className="text-center py-4">
                      ...
                      <p className="text-gray-600 text-sm font-['Open_Sans'] italic">
                        Estás viendo todos nuestros calzones. Explora diferentes tamaños para encontrar tu próximo favorito.
                      </p>
                    </div>
                  )}
                </div>
          ...
          {loading ? (
            <div className="flex justify-center items-center h-64">
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-lg text-gray-600 font-['Open_Sans']">Cargando deliciosos calzones...</p>
              </div>
            </div>
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-bold text-gray-800 font-['Playfair_Display'] mb-2">
                ¡Ups! No encontramos calzones
              </h3>
              <p className="text-gray-600 font-['Open_Sans']">
                No hay calzones disponibles para ese filtro. Intenta con otros criterios de búsqueda.
              </p>
            </div>
          ) : (
            <>
