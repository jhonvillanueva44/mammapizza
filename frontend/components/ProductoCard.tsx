  ...
  return (
    <div
      className="flex-shrink-0 bg-white rounded-xl p-4
        ...
        transition-all duration-300 snap-start font-[Poppins] flex flex-col justify-between"
    >
      <div>
      ...
      <button className="mt-3 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-2xl text-sm w-full">
        Agregar al Carrito
      </button>
    </div>
  );
