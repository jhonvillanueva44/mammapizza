            ...
            <div className="max-w-7xl mx-auto h-full px-6 sm:px-12 flex flex-col md:flex-row items-center md:items-start justify-between gap-10 relative z-10">
                ...
                <div className="flex-1 text-white flex flex-col justify-center h-full mt-15">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mb-8">
                        <button className="group relative overflow-hidden bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-8 py-4 rounded-2xl text-base font-medium font-['Open_Sans'] transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-2xl">
                        ...
                        <button className="group border-2 border-red-500 hover:border-red-400 text-red-400 hover:text-white px-8 py-4 rounded-2xl text-base font-medium font-['Open_Sans'] transition-all duration-300 hover:bg-red-500 backdrop-blur-sm">
