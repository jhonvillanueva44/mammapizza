...
export default function StockTable({ products, onAddProduct }: Props) {
  return (
                ...
                <tr key={product.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                      ...
                      product.status === 'Últimas unidades' ? 'bg-yellow-100 text-yellow-800' :
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    ...
                    <button className="text-gray-600 hover:text-gray-900">Eliminar</button>
                  </td>
                </tr>
              ))}
            </tbody>
